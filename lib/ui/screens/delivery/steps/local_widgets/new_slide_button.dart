...
enum ButtonState { NOT_CONFIRMED, CONFIRMED }

class NewSlideButton extends StatefulWidget {
  ...
  const NewSlideButton({
    ...
    this.buttonSize,
    this.width = 250,
    this.alignLabel = Alignment.center, //const Alignment(0.6, 0),
  ...
  @override
  _NewSlideButtonState createState() => _NewSlideButtonState();
}

class _NewSlideButtonState extends State<NewSlideButton> {
  late bool flag;
